...
void solve() {
	...
	// i can store each number as the number of active 1 primes
	// it will be like map<set<ll>, ll>
	map<SLL,ll> M;
	rep(i,0,n) {
		M[pf(A[i])]++;
	}
