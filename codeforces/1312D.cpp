...
void solve() {
	...
	ll ans = 0;
	rep(i,1,m+1) {
		// once youve set the big number, you can choose n-2 other numbers. 
		// you can then partition the n-2 other numbers
		// and then choose one to duplicate
		
		// choose n-2 numbers from i-1
		ll x = ncr(i-1, n-2);
